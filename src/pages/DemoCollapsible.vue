<template>
  <div class="demo-wrapper">
    <section class="section">
      <h2 class="section-title">Demo comportamiento lista colapsable</h2>
      <div class="grid">
        <CollapsibleList
          title="Frutas"
          :items="frutas"
...
<style scoped>
.demo-wrapper { max-width: 980px; margin: 0 auto; padding: 24px 16px; }
.section { margin-bottom: 36px; }
.section-title { margin: 8px 6px 12px; font-weight: 700; font-size: 24px; color: #000; }
.grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 16px; }
.emoji { font-size: 26px; width: 30px; display: inline-block; text-align: center; }
</style>
